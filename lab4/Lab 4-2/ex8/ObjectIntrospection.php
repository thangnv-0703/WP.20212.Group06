<?php
// return an arrya of callable methods (include inherited methods);
...
function print_object_info($object){
    ...
    array_pop($lineage);
    echo count($lineage) ? ('<p>'.join(' -&gt; ',$lineage).'</p>') : '<li>None</li>';
    echo '<h3>Children</h3>';
    ...
    if(!count($methods)){
        ...
        echo '<p>Inhetited methods are in <i>italics</i>.</p>';
